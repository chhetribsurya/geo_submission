    ...
    for fastq_acc in fastq_acc_list:
        ...
        if not fastq_acc_new.startswith("ENC"):
            ...
            try:
                ...
                GEO_ID = [fastq_acc_new + " in_progress"]
...
final_xls_df.to_excel(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_final.xlsx"))
...
final_xls_df_uniq.to_excel(join(GEO_ID_outdir, "ENCSR_ID_w_TF_name_final.xlsx"))
...
final_xls_df_uniq.to_excel(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_final_chip_control.xlsx"))
...
GEO_ID_df_final_reset.to_pickle(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_final.pkl"))
GEO_ID_df_final_reset = pd.read_pickle(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_final.pkl"))
pickle.dump(GEO_ID_dict, open(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_dict.pkl"), "wb"))  # save it into a file named open('save.p', "wb")
GEO_ID_dict = pickle.load(open(join(GEO_ID_outdir, "ENCSR_ID_final_details_w_fastqgz_v5_dict.pkl"), "rb"))
